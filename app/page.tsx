                    ...
                    <motion.div className="flex flex-col sm:flex-row items-center justify-center gap-5 text-center p-5 mt-10 sm:mt-4 w-full bg-beigecard rounded-2xl h-auto">
                        <div className="w-full sm:w-2/4 p-4 flex flex-col items-start justify-start h-full">
                            ...
                            <p className="text-cafeclaro text-start sm:text-center text-xl sm:text-2xl py-3 px-2">
                                <strong>Maestros Tapiceros en Madrid</strong>, un oficio que comenzó como parte de nuestra tradición familiar.
                                <strong>Con más de 25 años de experiencia</strong>, hemos perfeccionado el arte de la tapicería, eligiendo
                                <strong>los mejores materiales y técnicas de tapizado</strong> para lograr resultados de máxima calidad. En
                                Maestros Tapiceros, transformamos y renovamos cada mueble, llenándolo de <strong>color y confort</strong>, y
                                cuidando cada detalle para ofrecer un <strong>tapizado perfecto.</strong>
                            </p>
                        </div>
